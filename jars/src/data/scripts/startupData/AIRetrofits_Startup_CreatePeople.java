...
public class AIRetrofits_Startup_CreatePeople {
    ...
    public static void apply(){
        new AIRetrofit_CommandNodeType_Officer("officer",PersonWeight_Officer,true,true,true);
        new AIRetrofit_CommandNodeType_Admin("admin",PersonWeight_Admin,true,true,true);
    }
}
