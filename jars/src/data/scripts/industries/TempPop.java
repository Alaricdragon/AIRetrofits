...
public class TempPop extends BaseIndustry implements MarketImmigrationModifier {
...
//	}
    ...
    protected static class LampRemover implements EveryFrameScript {
        ...
        //CHANGED//
        protected TempPop industry;
        public LampRemover(SectorEntityToken lamp, MarketAPI market, TempPop industry) {//CHANGED//
            this.lamp = lamp;
            this.market = market;
            this.industry = industry;
        }
        public void advance(float amount) {
            Industry ind = market.getIndustry("my_mod_automatedworldcore");
