...
public class AIRetrofits_Patches_Nexerlin extends AIRetrofits_PatchBase {
    ...
    public void apply() {
        ...
        new AIRetrofit_ItemFoundMemory("$AIRetrofits_T2_Combat_found",AIRetrofits_Constants.Commodity_T2_CombatDrone,AIRetrofits_Startup_CrewReplacer.nexMarinesJob,crewReplacer_Main.getJob(AIRetrofits_Startup_CrewReplacer.nexMarinesJob).getCrew(AIRetrofits_Constants.Commodity_T2_CombatDrone));
        new AIRetrofit_ItemFoundMemory("$AIRetrofits_T2_Combat_found2",AIRetrofits_Constants.Commodity_T2_CombatDrone,AIRetrofits_Startup_CrewReplacer.nexTankMarinesJob,crewReplacer_Main.getJob(AIRetrofits_Startup_CrewReplacer.nexTankMarinesJob).getCrew(AIRetrofits_Constants.Commodity_T2_CombatDrone));
        /*new AIRetrofits_ItemInCargoMemory("",AIRetrofits_Constants.Commodity_T2_CombatDrone){
            @Override
